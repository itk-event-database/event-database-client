...
namespace Itk\EventDatabaseClient\v2;

use GuzzleHttp\Client as GuzzleHttpClient;
use GuzzleHttp\Exception\ClientException as GuzzleClientException;
use Itk\EventDatabaseClient\Exception\ClientException;
use Itk\EventDatabaseClient\v2\Item\Event;
use Itk\EventDatabaseClient\v2\Item\Occurrence;
use Itk\EventDatabaseClient\v2\Item\Place;
...
class Client
{
   ...
   *
   * @return \Itk\EventDatabaseClient\v2\Collection
   */
